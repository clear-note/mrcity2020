...
def mix(num, mixcount):
  ...
  ## 내 농장일경우 조합 안함
   if pyautogui.locateOnScreen('place/myroom1.png',confidence= 0.995)    :
       return 5
   ...
   #더블클릭 방지 블럭
   replacepoint = pyautogui.locateOnScreen('button/replacepoint.png',confidence= 0.99)
   pyautogui.click(replacepoint)
...
def visitMyroomTo():
   ...
   if pyautogui.locateOnScreen('place/shop.png',confidence= 0.95) is None:
        # 상점에 방문합니다
...
def OtherToHome():
     ...
     fulled = pyautogui.locateOnScreen('button/fulled.png',confidence= 0.98)
     if pyautogui.locateOnScreen('button/fulled.png',confidence= 0.98) :
      if  pyautogui.locateOnScreen('place/otherroom1.png',confidence= 0.95)   :
            gohome = pyautogui.locateOnScreen('button/gohome.png',confidence= 0.95)
            
            print("retuen home..")
            pyautogui.click(gohome)
            pyautogui.click(fulled)
            exception()
...
def friendVisit()  : 
    try:
        ...
        time.sleep(0.1)
        if pyautogui.locateOnScreen('button/friend1.png',confidence= 0.94)== None:
            # 친구메뉴 소환
